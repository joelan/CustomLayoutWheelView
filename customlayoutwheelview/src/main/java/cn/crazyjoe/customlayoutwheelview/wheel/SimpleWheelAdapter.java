...
class SimpleWheelAdapter extends RecyclerView.Adapter {
    ...
    SimpleWheelAdapter(RecyclerView.Adapter adapter, int orientation, int itemSize, int itemCount) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        RecyclerView.ViewHolder vh = adapter.onCreateViewHolder(parent, viewType);
