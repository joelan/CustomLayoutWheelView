...
import cn.crazyjoe.customlayoutwheelview.R;
...
public class WheelView extends ViewGroup {
    ...
    public void setAdapter(RecyclerView.Adapter adapter) {
        if (adapter == null) {
         ...
         wheelAdapter = new SimpleWheelAdapter(adapter, orientation, itemSize, itemCount);
    ...
    public  void scrollToposition(int position)
    {
        ...
        {
        mRecyclerView.getmLayoutManager().scrollToPosition(position);
