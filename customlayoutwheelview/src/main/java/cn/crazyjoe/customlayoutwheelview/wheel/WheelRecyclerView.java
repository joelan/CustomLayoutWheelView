package cn.crazyjoe.customlayoutwheelview.wheel;
...
public class WheelRecyclerView extends RecyclerView {
     ...
     * 阴影遮罩颜色渐变
     */
    private static final int CENTER_COLOR = Color.parseColor("#002F192A");
    private static final int EDGE_COLOR = Color.parseColor("#ff2F192A");
    ...
    public WheelRecyclerView(Context context, int gravity, int itemCount, int itemSize, int orientation, int dividerColor, int dividerSize) {
        ...
        //之前是2
        this.itemDegree = 180.f / (itemCount * 8 + 1);
       // this.itemDegree=10.f;
...
//        float rotateOffY = scrollOffY - wheelRadio * rotateSinX;//因旋转导致界面视角的偏移
        ...
        float  rate=Math.abs(scrollOffY/itemSize);
        ...
        if(rate>1)
        {
         ...
         child.setScaleX(1-rate*(1-scale));
        child.setScaleY(1-rate*(1-scale));
